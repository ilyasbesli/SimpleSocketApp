...
public class ServerSocketPlayer implements Runnable {
    ...
    // FIXME host parameter do you really need as parameter? You never use it.
     ...
     *
     * @throws IOException {@link ServerSocketPlayer#input} should throw an {@link IOException} exception.
     */
    ...
    /**
     * initialize server socket on {@link ServerSocketPlayer#port}
     */
